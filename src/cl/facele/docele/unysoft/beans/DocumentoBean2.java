...
public class DocumentoBean2 {
	...
	List<DetalleBean_1> detalles = new ArrayList<DetalleBean_1>();
	 ...
	 * @return the detalles
	 */
	public List<DetalleBean_1> getDetalles() {
		return detalles;
	}
	 ...
	 */
	public void setDetalles(DetalleBean_1 detalle) {
	...
	public void setDetalles(List<DetalleBean_1> detalles) {
